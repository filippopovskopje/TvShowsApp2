...
namespace TvShowsApp.Controllers
{
    ...
    public class TvShowsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TvId,Title,Genre,Rating,ImdbUrl,ImageUrl")] TvShow tvShow)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TvId,Title,Genre,Rating,ImdbUrl,ImageUrl")] TvShow tvShow)
        {
            if (id != tvShow.TvId)
            {
                return NotFound();
        ...
        {
            return _context.TvShow.Any(e => e.TvId == id);
        }
